...
export function QuickActionSidebarNav({
  ...
  return (
    <>
      <aside
        className={cn(
          "flex h-[860px] w-[340px] flex-col overflow-hidden rounded-md border border-slate-200 bg-[#f8f9fb] shadow-sm",
          className
        )}
        {...props}
      >
        ...
        <div className="space-y-4 border-t border-slate-200 bg-[#f8f9fb] px-5 py-4">
          <button
            type="button"
